...
class SLASH(object):
    ...
    def networkAtom2MVPPrules(self, networkAtom, npp_operators):
        ...
        #print('The m: {}, network type: {}, inf_type: {}, e: {}, t: {}, domain: {}'.format(m,network_type,inf_type,e,t,domain))
    ...
    def learn(self, dataset_loader, epoch, method='exact', lr=0.01, opt=False, batchSize=1, use_em=False, train_slot=False,  slot_net=None, p_num=1, marginalisation_masks=None):
        ...
        for epochIdx in range(epoch):
            ...
            # Type 1:
            # dataset_loader format ---> [{'i1':tensor of 1st image, 'i2':tensor of 2nd image}, rule] 
            # (rule->ex:':- not addition(i1, i2, 4).)
            # Type 2:
            ...
            for data_batch, query_batch in tqdm(dataset_loader):
                ...
                # print("network types", self.networkTypes)
                # print("network mapping",self.networkMapping)
                # print('----------------')
