...
# sys.path.append('C:/Saravana/Projects/SLASH/src/datasets.py')
...
test_loader = torch.utils.data.DataLoader(COVTYPE(root='./Neuro-symbolic-AI/SLASH/covtype/data/covtype.data',mode='test'), batch_size=100, shuffle=True)
# test_loader = torch.utils.data.DataLoader(COVTYPE(root='../../data/covtype/covtype.data',mode='test'), batch_size=100, shuffle=True)
...
class FOREST_COVERAGE_TYPE(Dataset):
    def __init__(self, root, mode):
