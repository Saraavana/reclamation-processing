...
sys.path.append('C:/Saravana/Projects/Intellizenz/intellizenz-model-training/Neuro-symbolic-AI/SLASH/')
...
def maybe_download_covtype():
    # directory = "../../data/"
    directory = "./Neuro-symbolic-AI/SLASH/covtype/data/"
    ...
    filepath_extracted = os.path.join(directory,"covtype.data")
